package com.harvest.harvestservice;
...
@OpenAPIDefinition(
		info = @Info(
				title = "Harvest Service Rest APIS Documentation",
				description = "Harvest Service Rest Apis it is part the myKcc microservice",
				version = "3.3.1",
				contact = @Contact(
						name = "myKcc-Project",
		...
		externalDocs = @ExternalDocumentation(
				description = "Harvest-service-docs",
